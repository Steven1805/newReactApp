export const headTable = [
  {headName: "Name", headPosition: "Position", headOffice: "Office", headAge: "Age", headStartDate: "Start Date", headSalary: "Salary"},

]


export function renderTable (firstEntry, firstIndex) {
  return(
    <tr key={firstIndex}>
      <th>{firstEntry.headName}</th>
      <th>{firstEntry.headPosition}</th>
      <th>{firstEntry.headOffice}</th>
      <th>{firstEntry.headAge}</th>
      <th>{firstEntry.headStartDate}</th>
      <th>{firstEntry.headSalary}</th>
    </tr>
  )
}
...
export const tableElements = [
    {name: "Tyger Nixton", position: "System Architect", office: "Edingburg", age: "61", startdate: "2011/04/25", salary: "$320,800" },
    ...
    {name: "Serge Baldwin", position: "Data Coordinator", office: "Singapore", age: "64", startdate: "2012/04/092012/04/09", salary: "$138,575" },
